...
The maximum size of a Virtual Surface is 2^24(16M) pixels. This limit has been imposed because of floating point precision limits, that come into play beyond that size, which prevents guarenteed accurate pixel alignment of drawn patches.
